...
class Song:
    ...
    def create_embed(self):
        embed = embed = (discord.Embed(title=' <:YouTube:903586158859132959> Now Playing :notes:', description='**```css\n{0.source.title}\n```**'.format(self), color=discord.Color.blurple())
                ...
                .set_footer(text="First time? Do =help",icon_url="https://cdn.discordapp.com/emojis/889708896694964254.png?size=96")
...
class Music(commands.Cog):
    ...
    async def cog_command_error(self, ctx: commands.Context, error: commands.CommandError):
        await ctx.send('<@696599329011400775> 有error不check要生蛋吗？ :  {}'.format(str(error)))

    @commands.Cog.listener()
    async def on_ready(self):
      print('cog listener is ready!.')
    ...
    async def _leave(self, ctx: commands.Context):
        ...
        await ctx.send(" Bot has been **successful disconnected!**")
    ...
    async def _volume(self, ctx: commands.Context, *, volume: int):
        ...
        await ctx.send(':loud_sound:  Volume of the player set to {}%'.format(volume))
    ...
    @commands.command(name='skip', aliases=['s' , "forceskip" , "fs" , "force skip"])
    ...
    async def _play(self, ctx: commands.Context, *, search: str):
        ...
        async with ctx.typing():
            try:
                ...
                await ctx.send('Searching 🔎 {}'.format(str(source)))
        await ctx.message.add_reaction('🔎')
